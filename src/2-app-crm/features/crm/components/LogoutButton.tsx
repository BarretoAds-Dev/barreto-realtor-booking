...
export default function LogoutButton({ showChangeUser = false, isCollapsed = false }: LogoutButtonProps) {
	...
	useEffect(() => {
		...
		modalRoot.style.cssText = 'position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 9999;';
					...
					<div class="bg-white rounded-xl border-2 border-gray-100 shadow-lg overflow-hidden">
						...
						<div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
							<div class="flex items-center gap-3">
								...
								<div>
									<h3 class="text-lg font-bold text-gray-900">Confirmar cierre de sesión</h3>
									<p class="text-xs text-gray-600">Esta acción cerrará tu sesión actual</p>
								</div>
							</div>
						</div>
